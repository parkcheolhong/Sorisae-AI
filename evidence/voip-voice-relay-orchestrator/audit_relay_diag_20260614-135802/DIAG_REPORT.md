# Audit + Relay Diagnosis 20260614-135802
...
## Call flow
- Accept API: `True`
- Signaling open (callee): `True`

## S10 audit (after 새로고침)
- logcat VOIP_CALL_MODE_AUDIT_LOADED: `True`
...
- VOIP_CALL_MODE_AUDIT_LOADED: `True`
