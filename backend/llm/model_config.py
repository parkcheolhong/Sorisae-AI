...
UPPER_TIER_QWEN_72B = "qwen2.5:72b"
...
def _build_configured_model_routes(*, resolve_live: bool) -> Dict[str, str]:
    routes = {
...
def get_configured_model_routes() -> Dict[str, str]:
    ...
    return _build_configured_model_routes(resolve_live=resolve_live)
...
def _runtime_profile_payload(key: str, label: str, description: str, hardware_hint: str, available_models: List[str]) -> Dict[str, Any]:
    ...
    if key == CURRENT_GPU_PROFILE_KEY:
        ...
        model_routes = {
            "default": _pick_first_available(available_models, [UPPER_TIER_QWEN_72B, "llama3.3:70b", "deepseek-r1:70b", OLLAMA_QWEN_CODER_32B], fallback_default),
            "reasoning": _pick_first_available(available_models, ["deepseek-r1:70b", UPPER_TIER_QWEN_72B, "qwq:32b"], fallback_default),
            "coding": _pick_first_available(available_models, [UPPER_TIER_QWEN_72B, "deepseek-r1:70b", OLLAMA_QWEN_CODER_32B], fallback_default),
            "chat": _pick_first_available(available_models, ["llama3.3:70b", UPPER_TIER_QWEN_72B, "gemma3:27b"], fallback_default),
            "voice_chat": _pick_first_available(available_models, ["glm4:latest", "gemma3:27b"], fallback_default),
            "planner": _pick_first_available(available_models, ["deepseek-r1:70b", UPPER_TIER_QWEN_72B, "qwq:32b"], fallback_default),
            "coder": _pick_first_available(available_models, [UPPER_TIER_QWEN_72B, "deepseek-r1:70b", OLLAMA_QWEN_CODER_32B], fallback_default),
            "reviewer": _pick_first_available(available_models, ["deepseek-r1:70b", UPPER_TIER_QWEN_72B, "deepseek-r1:32b"], fallback_default),
            "designer": _pick_first_available(available_models, ["llama3.3:70b", UPPER_TIER_QWEN_72B, "gemma3:27b"], fallback_default),
            "smart_planner": _pick_first_available(available_models, ["deepseek-r1:70b", UPPER_TIER_QWEN_72B, "qwq:32b"], fallback_default),
            "smart_executor": _pick_first_available(available_models, [UPPER_TIER_QWEN_72B, "deepseek-r1:70b", OLLAMA_QWEN_CODER_32B], fallback_default),
            "smart_designer": _pick_first_available(available_models, ["llama3.3:70b", UPPER_TIER_QWEN_72B, "gemma3:27b"], fallback_default),
        }
        settings = {
...
def get_available_ollama_models() -> List[str]:
    ...
    # Avoid recursive resolution loop while computing live model availability.
    configured = _build_configured_model_routes(resolve_live=False)
