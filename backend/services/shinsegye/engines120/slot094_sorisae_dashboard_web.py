...
allowed_origins_raw = os.environ.get(
    "SORISAE_DASHBOARD_CORS_ORIGINS",
    "http://localhost:5050,http://127.0.0.1:5050,http://localhost:15094,http://127.0.0.1:15094",
)
allowed_origins = [origin.strip() for origin in allowed_origins_raw.split(",") if origin.strip()]
socketio = SocketIO(app, cors_allowed_origins=allowed_origins)  # CORS 제한
