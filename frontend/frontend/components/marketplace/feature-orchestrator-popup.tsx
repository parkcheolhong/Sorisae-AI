...
export default function FeatureOrchestratorPopup(props: FeatureOrchestratorPopupProps) {
    ...
    return (
        <div className="fixed inset-0 z-50 flex items-start justify-center overflow-y-auto bg-black/80 px-2 py-3 backdrop-blur-sm sm:px-4 sm:py-8" data-testid="marketplace-feature-orchestrator-popup" onMouseDown={(event) => {
            ...
            <div
                ...
                className="my-auto w-full max-w-6xl overflow-x-hidden overflow-y-auto rounded-[24px] border border-[#2a364f] bg-[#0b0f16] p-3 text-[#e6edf3] shadow-[0_30px_120px_rgba(0,0,0,0.45)] outline-none sm:max-h-[92vh] sm:rounded-[28px] sm:p-6"
            >
                <div className="mb-5 rounded-2xl border border-[#1f2937] bg-[linear-gradient(180deg,rgba(15,23,38,0.98),rgba(11,15,22,0.96))] px-4 py-4 sm:mb-6 sm:px-5 sm:py-5">
                <div className="flex flex-col gap-4 lg:flex-row lg:items-start lg:justify-between">
                    <div className="min-w-0 flex-1">
                        ...
                        <p id={descriptionId} className="mt-3 max-w-[980px] text-sm leading-7 text-[#a8b6c8]">{props.featureSummary}</p>
                    ...
                    <div className="flex w-full flex-col gap-2 sm:flex-row lg:w-auto lg:flex-col lg:items-end">
                ...
                <div ref={contentStartRef} className="grid gap-4 sm:gap-6 xl:grid-cols-[1fr_1fr]" data-testid="marketplace-popup-content-grid">
                    ...
                    <FeaturePopupOutputSection
                        ...
                        downloadTitle={meta.downloadTitle}
                        downloadDescription={meta.downloadDescription}
