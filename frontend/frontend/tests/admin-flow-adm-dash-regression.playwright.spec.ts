...
const ADMIN_REGRESSION_MOCK_BACKEND = ['1', 'true', 'yes'].includes(String(process.env.ADMIN_REGRESSION_MOCK_BACKEND || '').trim().toLowerCase())
    && ['1', 'true', 'yes'].includes(String(process.env.CI || '').trim().toLowerCase());
