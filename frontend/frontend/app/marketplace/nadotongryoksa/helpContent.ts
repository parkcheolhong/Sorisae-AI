 ...
 *
 * 17개 언어에 대해 완전 번역된 콘텐츠를 제공합니다:
 * ko, en, ja, zh, zh-tw, es, fr, de, pt, ru, ar, hi, it, tr, vi, th, id
 * 그 외 언어 코드는 영어(en)로 폴백됩니다.
 * 언어 선택 목록(helpLangList.ts)은 50개국어를 지원하나, 완전 번역 콘텐츠는 위 17개 언어입니다.
