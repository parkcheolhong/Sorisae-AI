...
- [x] 소리새 패스키/FAB 통합 닫기 체크리스트를 readiness 문서에 참조 연결했다.
  - 근거: [docs/checklists/sorisae-passkey-fab-integrated-close-checklist-20260816.md](docs/checklists/sorisae-passkey-fab-integrated-close-checklist-20260816.md)
  - 근거: 2연속 실검증 PASS 번들 [evidence/apk-passkey-real-token-e2e-20260816-rerun11-after-reinstall](evidence/apk-passkey-real-token-e2e-20260816-rerun11-after-reinstall), [evidence/apk-passkey-real-token-e2e-20260816-rerun12-after-reinstall](evidence/apk-passkey-real-token-e2e-20260816-rerun12-after-reinstall)
