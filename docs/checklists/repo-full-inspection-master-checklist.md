...
- [x] 소리새 패스키/FAB 통합 닫기 체크리스트를 상위 마스터 문서에 참조 연결했다.
  ...
  - 근거: [docs/checklists/worldlinco-app-improvement-checklist-20260812.md](docs/checklists/worldlinco-app-improvement-checklist-20260812.md)와 본 문서의 교차 참조 반영
