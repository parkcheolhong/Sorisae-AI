...
export type AppEntryDeepLinkTarget =
    ...
    | {
        type: 'auth';
        provider?: string;
        authMode?: 'passkey_login' | 'passkey_register';
        accessToken: string;
        refreshToken?: string;
        idToken?: string;
        expiresInSec?: number;
    ...
    | { type: 'voip'; action: 'open' | 'validation' | 'incoming'; callId?: string; calleeVoiceId?: string; forceRetry?: boolean; preferredLanguage?: string; calleePreferredLanguage?: string };
