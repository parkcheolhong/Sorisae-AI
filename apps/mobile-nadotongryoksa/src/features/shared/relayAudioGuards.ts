/**
 * Shared relay audio silence guards.
 */

// Mic baseline retest (2026-07-05): device_B silent-skip cluster centered near -66 dB.
// Lowering from -58 to -66 reduces false silent drops while server-side trust/noise gates remain active.
export const VOICE_RELAY_FILE_SPEECH_RMS_DB = -66;
