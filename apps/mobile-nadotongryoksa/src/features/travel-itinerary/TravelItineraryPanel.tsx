...
const styles = StyleSheet.create({
  ...
  title: { color: '#1a1f36', fontWeight: '800', fontSize: 15 },
  subtitle: { color: '#1e6fe0', fontSize: 12 },
  hint: { color: '#5f6b80', fontSize: 12, marginTop: 6, lineHeight: 17 },
  consentWrap: {
    marginTop: 10,
    padding: 12,
    borderRadius: 12,
  ...
  consentText: { color: '#3a4356', fontSize: 12, lineHeight: 18 },
  ...
  consentBtnText: { color: '#3a4356', fontWeight: '700', fontSize: 12 },
  ...
  consentStatusText: { color: '#1e6fe0', fontSize: 11, fontWeight: '700' },
  input: {
    marginTop: 10,
    minHeight: 44,
    maxHeight: 96,
  ...
  label: { color: '#3a4356', fontSize: 12, marginTop: 12, marginBottom: 6 },
  ...
  dayBtnText: { color: '#3a4356', fontWeight: '700', fontSize: 13 },
  ...
  summary: { color: '#1a1f36', fontSize: 14, marginTop: 14, lineHeight: 20, fontWeight: '600' },
  kgWrap: {
    marginTop: 12,
    padding: 12,
    borderRadius: 12,
  ...
  kgTitle: { color: '#7c3aed', fontWeight: '800', fontSize: 13, marginBottom: 8 },
  kgSection: { marginTop: 6 },
  kgLabel: { color: '#7c3aed', fontSize: 12, fontWeight: '700', marginBottom: 4 },
  kgRow: { marginTop: 4 },
  kgName: { color: '#1a1f36', fontSize: 13, fontWeight: '600' },
  kgDesc: { color: '#6b6790', fontSize: 12, marginTop: 1, lineHeight: 17 },
  kgFoods: { color: '#4a4470', fontSize: 13, lineHeight: 19 },
  mapWrap: {
    marginTop: 12,
    height: 220,
    borderRadius: 12,
  ...
  mapWebView: { flex: 1, backgroundColor: '#eef4fb' },
  dayCard: {
    marginTop: 12,
    padding: 12,
    borderRadius: 12,
  ...
  dayCardTitle: { color: '#1e6fe0', fontWeight: '800', fontSize: 14, marginBottom: 8 },
  placeRow: {
    paddingVertical: 8,
  ...
  placeName: { color: '#1a1f36', fontWeight: '700', fontSize: 14 },
  placeBlurb: { color: '#3a4356', fontSize: 13, marginTop: 3, lineHeight: 18 },
  placeMeta: { color: '#5f6b80', fontSize: 12, marginTop: 2 },
  mapLinkBtn: {
  ...
  mapLinkText: { color: '#1e6fe0', fontWeight: '700', fontSize: 12 },
  tipsWrap: {
    marginTop: 14,
    padding: 12,
    borderRadius: 12,
  ...
  tipsTitle: { color: '#1f9d57', fontWeight: '800', fontSize: 13, marginBottom: 6 },
  tipText: { color: '#2f6b43', fontSize: 13, marginTop: 4, lineHeight: 18 },
  disclosure: { color: '#5f6b80', fontSize: 11, marginTop: 12, lineHeight: 16 },
  attribution: { color: '#8a93a3', fontSize: 10, marginTop: 4, textAlign: 'right' },
  fbWrap: {
    marginTop: 14,
    padding: 12,
    borderRadius: 12,
  ...
  fbTitle: { color: '#1a1f36', fontWeight: '800', fontSize: 13 },
  ...
  fbThumbText: { color: '#3a4356', fontWeight: '700', fontSize: 12 },
  fbThumbTextSel: { color: '#fff' },
  fbNpsLabel: { color: '#5f6b80', fontSize: 11, marginTop: 12 },
  ...
  fbNpsSel: { backgroundColor: '#e6f7ef', borderColor: '#19c37d' },
  fbNpsText: { color: '#3a4356', fontWeight: '700', fontSize: 12 },
  fbNpsTextSel: { color: '#1f9d57' },
  fbComment: {
    marginTop: 10,
    minHeight: 38,
    borderRadius: 10,
  ...
  fbThanks: { color: '#1f9d57', fontSize: 13, fontWeight: '700', textAlign: 'center', paddingVertical: 6 },
});
