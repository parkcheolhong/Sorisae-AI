...
/** Legacy slugs/paths kept for API and marketplace compatibility. */
...
export const WORLDLINGO_VOIP_CALLER_ID = 'user@worldlinco';
...
export function matchesWorldLincoProjectFields(fields: Array<unknown>): boolean {
    const haystack = normalizeWorldLincoSearchText(fields.join(' '));
    return matchesWorldLincoProjectHaystack(haystack);
}
