...
const FIREBASE_ANDROID_OPTIONS = {
    ...
    databaseURL: 'https://studio-9080238625-9cec3.firebaseio.com',
...
if (firebase.apps.length > 0) {
    ...
    console.log('[WorldlincoFCM] skipping background handler because firebase default app is unavailable');
}
